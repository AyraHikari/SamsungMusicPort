...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/samsung/auth/Locale$AccessType;

    const-string v3, "SamsungBooks"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/samsung/auth/Locale$AccessType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/samsung/auth/Locale$AccessType;->SamsungBooks:Lcom/samsung/auth/Locale$AccessType;

    new-instance v3, Lcom/samsung/auth/Locale$AccessType;

    const-string v5, "SamsungLearning"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/samsung/auth/Locale$AccessType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/samsung/auth/Locale$AccessType;->SamsungLearning:Lcom/samsung/auth/Locale$AccessType;

    new-instance v5, Lcom/samsung/auth/Locale$AccessType;

    const-string v7, "MusicRadio"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/samsung/auth/Locale$AccessType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/samsung/auth/Locale$AccessType;->MusicRadio:Lcom/samsung/auth/Locale$AccessType;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/samsung/auth/Locale$AccessType;
    ...
    .line 2
    sput-object v7, Lcom/samsung/auth/Locale$AccessType;->$VALUES:[Lcom/samsung/auth/Locale$AccessType;
