.class final Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment$AlbumCheckableList;
...
.method public constructor <init>(Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment;Lcom/samsung/android/app/musiclibrary/ui/widget/MusicRecyclerView;)V
    ...
    .line 206
    iput-object p1, p0, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment$AlbumCheckableList;->a:Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment;
...
.method protected a(Landroid/util/SparseBooleanArray;I)[J
    ...
    .line 214
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment$AlbumCheckableList;->c()Lcom/samsung/android/app/musiclibrary/ui/widget/MusicRecyclerView;
    ...
    iget-object v2, p0, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment$AlbumCheckableList;->a:Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment;->b(I)Lcom/samsung/android/app/musiclibrary/ui/list/query/QueryArgs;
    ...
    invoke-virtual {v2}, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment;->D()Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;

    move-result-object v2

    check-cast v2, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment$ArtistAlbumDetailAdapter;

    invoke-virtual {v2, p1}, Lcom/samsung/android/app/music/list/local/ArtistAlbumDetailFragment$ArtistAlbumDetailAdapter;->getItemKeywords(Landroid/util/SparseBooleanArray;)[Ljava/lang/String;
