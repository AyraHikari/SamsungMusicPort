.class public final Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$ActionModeOptionsMenu;,
        Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$ComposerDetailFilterableImpl;,
        Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$Companion;
    }
.end annotation
...
# static fields
.field public static final a:Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a:Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$Companion;
...
.method public constructor <init>()V
    ...
    .line 59
    new-instance v0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$onItemClickListener$1;

    invoke-direct {v0, p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$onItemClickListener$1;-><init>(Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;)V

    check-cast v0, Lcom/samsung/android/app/musiclibrary/ui/list/OnItemClickListener;

    iput-object v0, p0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->c:Lcom/samsung/android/app/musiclibrary/ui/list/OnItemClickListener;
...
.method public synthetic A()Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;
    ...
    .line 55
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->c()Lcom/samsung/android/app/music/list/local/DefaultTrackAdapter;
...
.method public a(Landroid/support/v4/content/Loader;Landroid/database/Cursor;)V
    ...
    .line 118
    invoke-virtual {p0, p2}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Landroid/database/Cursor;)Z
...
.method protected b(I)Lcom/samsung/android/app/musiclibrary/ui/list/query/QueryArgs;
    ...
    .line 147
    new-instance p1, Lcom/samsung/android/app/musiclibrary/ui/list/query/ComposerTrackQueryArgs;

    .line 148
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->getArguments()Landroid/os/Bundle;
    ...
    .line 149
    iget-object v1, p0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->b:Lcom/samsung/android/app/music/list/common/ListHeaderManager;
    ...
    .line 147
    invoke-direct {p1, v0, v1}, Lcom/samsung/android/app/musiclibrary/ui/list/query/ComposerTrackQueryArgs;-><init>(Ljava/lang/String;I)V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    .line 65
    invoke-virtual {p0, p1, v0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    iput-object v6, p0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->contextMenu:Lcom/samsung/android/app/musiclibrary/ui/menu/IMusicMenu;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->D()Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;

    move-result-object v0

    check-cast v0, Lcom/samsung/android/app/music/list/local/DefaultTrackAdapter;

    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->getRecyclerView()Lcom/samsung/android/app/musiclibrary/ui/widget/MusicRecyclerView;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->musicMenu:Lcom/samsung/android/app/musiclibrary/ui/menu/IMusicMenu;
...
.method public synthetic onLoadFinished(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Landroid/support/v4/content/Loader;Landroid/database/Cursor;)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 86
    iget-object v4, v0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->c:Lcom/samsung/android/app/musiclibrary/ui/list/OnItemClickListener;

    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/OnItemClickListener;)V

    .line 88
    new-instance v4, Lcom/samsung/android/app/musiclibrary/ui/list/selectmode/SelectAllImpl;

    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->getActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/selectmode/ISelectAll;)V

    .line 89
    sget v4, Lcom/samsung/android/app/musiclibrary/ui/widget/MusicRecyclerView;->e:I

    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->b_(I)V

    .line 90
    new-instance v4, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$ActionModeOptionsMenu;

    invoke-direct {v4, v0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$ActionModeOptionsMenu;-><init>(Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;)V

    check-cast v4, Lcom/samsung/android/app/musiclibrary/ui/menu/ActionModeMenu;

    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/menu/ActionModeMenu;)V
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerViewFragment$ListAnalytics;)V
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/Deleteable;)V
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/Playable;)V
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/Shareable;)V
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/IndexViewable;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->h()Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/Favoriteable;)V

    .line 99
    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->getRecyclerView()Lcom/samsung/android/app/musiclibrary/ui/widget/MusicRecyclerView;
    ...
    .line 102
    new-instance v5, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$ComposerDetailFilterableImpl;

    invoke-direct {v5}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment$ComposerDetailFilterableImpl;-><init>()V
    ...
    iput-object v4, v0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->b:Lcom/samsung/android/app/music/list/common/ListHeaderManager;

    .line 107
    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->D()Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerCursorAdapter;
    ...
    iget-object v7, v0, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->b:Lcom/samsung/android/app/music/list/common/ListHeaderManager;
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(Lcom/samsung/android/app/musiclibrary/ui/list/RecyclerViewFragment$EmptyViewCreator;)V

    .line 111
    invoke-virtual {v0, v1, v2}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->a(ZI)V

    .line 112
    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->g()I
...
.method protected u()Landroid/support/v7/widget/RecyclerView$LayoutManager;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/app/music/list/local/ComposerDetailFragment;->getActivity()Landroid/support/v4/app/FragmentActivity;
