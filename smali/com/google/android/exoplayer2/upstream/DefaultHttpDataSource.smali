...
.field private final h:Lcom/google/android/exoplayer2/util/Predicate;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final k:Lcom/google/android/exoplayer2/upstream/TransferListener;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->b:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public constructor <init>(Ljava/lang/String;Lcom/google/android/exoplayer2/util/Predicate;Lcom/google/android/exoplayer2/upstream/TransferListener;IIZLcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->g:Ljava/lang/String;

    .line 149
    iput-object p2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->h:Lcom/google/android/exoplayer2/util/Predicate;

    .line 150
    iput-object p3, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->k:Lcom/google/android/exoplayer2/upstream/TransferListener;
    ...
    .line 152
    iput p4, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->e:I

    .line 153
    iput p5, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->f:I

    .line 154
    iput-boolean p6, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->d:Z

    .line 155
    iput-object p7, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->i:Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;
...
.method private static a(Ljava/net/HttpURLConnection;)J
    ...
    .line 481
    sget-object v3, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->b:Ljava/util/regex/Pattern;
...
.method private a(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    .line 394
    iget v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->e:I
    ...
    .line 396
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->i:Lcom/google/android/exoplayer2/upstream/HttpDataSource$RequestProperties;
    ...
    .line 411
    iget-object p4, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->g:Ljava/lang/String;
...
.method private b([BII)I
    ...
    iget-wide v5, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->s:J
    ...
    .line 573
    iget-wide p1, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->q:J
    ...
    .line 580
    :cond_4
    iget-wide p2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->s:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->s:J

    .line 581
    iget-object p2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->k:Lcom/google/android/exoplayer2/upstream/TransferListener;
    ...
    invoke-interface {p2, p0, p1}, Lcom/google/android/exoplayer2/upstream/TransferListener;->a(Ljava/lang/Object;I)V

    :cond_5
    return p1
.end method

.method private b(Lcom/google/android/exoplayer2/upstream/DataSpec;)Ljava/net/HttpURLConnection;
    .locals 19
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 342
    iget-object v2, v0, Lcom/google/android/exoplayer2/upstream/DataSpec;->b:[B

    .line 343
    iget-wide v12, v0, Lcom/google/android/exoplayer2/upstream/DataSpec;->d:J
    ...
    .line 345
    invoke-virtual {v0, v3}, Lcom/google/android/exoplayer2/upstream/DataSpec;->a(I)Z
    ...
    .line 347
    iget-boolean v0, v11, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->d:Z
    ...
    .line 350
    invoke-direct/range {v0 .. v8}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->a(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    .line 356
    invoke-direct/range {v3 .. v11}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->a(Ljava/net/URL;[BJJZZ)Ljava/net/HttpURLConnection;
    ...
    .line 371
    invoke-static {v1, v3}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->a(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
...
.method private d()V
    ...
    iget-wide v2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->p:J
    ...
    .line 521
    :cond_0
    sget-object v0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    :goto_0
    iget-wide v1, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->r:J

    iget-wide v3, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->p:J
    ...
    .line 527
    iget-wide v1, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->p:J

    iget-wide v3, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->r:J
    ...
    iput-wide v2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->r:J

    .line 536
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->k:Lcom/google/android/exoplayer2/upstream/TransferListener;
    ...
    invoke-interface {v2, p0, v1}, Lcom/google/android/exoplayer2/upstream/TransferListener;->a(Ljava/lang/Object;I)V
    ...
    .line 542
    :cond_4
    sget-object v1, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public a([BII)I
    ...
    .line 266
    :try_start_0
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->d()V
...
.method public a(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    .line 189
    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->s:J
    ...
    .line 192
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->b(Lcom/google/android/exoplayer2/upstream/DataSpec;)Ljava/net/HttpURLConnection;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->m:Ljava/net/HttpURLConnection;
    :try_end_0
    ...
    .line 220
    :cond_0
    iget-object v5, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->m:Ljava/net/HttpURLConnection;
    ...
    .line 221
    iget-object v6, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->h:Lcom/google/android/exoplayer2/util/Predicate;

    if-eqz v6, :cond_2

    iget-object v6, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->h:Lcom/google/android/exoplayer2/util/Predicate;

    invoke-interface {v6, v5}, Lcom/google/android/exoplayer2/util/Predicate;->a(Ljava/lang/Object;)Z
    ...
    .line 222
    :cond_1
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->e()V
    ...
    .line 229
    iget-wide v3, p1, Lcom/google/android/exoplayer2/upstream/DataSpec;->d:J

    cmp-long v3, v3, v0

    if-eqz v3, :cond_3

    iget-wide v0, p1, Lcom/google/android/exoplayer2/upstream/DataSpec;->d:J

    :cond_3
    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->p:J

    .line 232
    invoke-virtual {p1, v2}, Lcom/google/android/exoplayer2/upstream/DataSpec;->a(I)Z
    ...
    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->q:J
    ...
    :cond_5
    iput-wide v3, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->q:J
    ...
    .line 255
    iput-boolean v2, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->o:Z

    .line 256
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultHttpDataSource;->k:Lcom/google/android/exoplayer2/upstream/TransferListener;
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/android/exoplayer2/upstream/TransferListener;->a(Ljava/lang/Object;Lcom/google/android/exoplayer2/upstream/DataSpec;)V
...
.method public a()V
    ...
    invoke-interface {v0, p0}, Lcom/google/android/exoplayer2/upstream/TransferListener;->a(Ljava/lang/Object;)V
