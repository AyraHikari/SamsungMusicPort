...
.method public constructor <init>(Lcom/google/android/exoplayer2/extractor/TrackOutput;ZZ)V
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->g:[B

    const/4 p3, 0x0

    invoke-direct {p1, p2, p3, p3}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;-><init>([BII)V

    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->f:Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;

    .line 258
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->b()V
...
.method public a(JI)V
    ...
    .line 422
    :cond_0
    iget-boolean v0, p0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->o:Z
    ...
    .line 424
    invoke-direct {p0, p3}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->a(I)V
    ...
    iget-boolean p2, p0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->b:Z
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->n:Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;

    .line 432
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->b()Z
...
.method public a(JIJ)V
    ...
    iget p1, p0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->i:I
    ...
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->a()V
...
.method public a([BII)V
    ...
    iget-object v2, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->g:[B

    iget v3, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->h:I

    const/4 v4, 0x0

    invoke-virtual {v1, v2, v4, v3}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->a([BII)V
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->a()V

    .line 320
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->f:Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;

    invoke-virtual {v1, v5}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->c(I)I
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->a(I)V
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->d()I
    ...
    invoke-virtual {v1, v9}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->a(I)V
    ...
    iget v6, v1, Lcom/google/android/exoplayer2/util/NalUnitUtil$PpsData;->b:I
    ...
    .line 350
    iget-boolean v3, v7, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->e:Z
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->a(I)V

    .line 356
    :cond_9
    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->f:Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;

    iget v5, v7, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->g:I
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->c(I)I

    move-result v10

    .line 363
    iget-boolean v3, v7, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->f:Z
    ...
    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->b()Z
    ...
    invoke-virtual {v6}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->b()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->d()I
    ...
    .line 388
    :goto_3
    iget v2, v7, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->h:I
    ...
    iget v3, v7, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->i:I
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->c(I)I
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->e()I
    ...
    iget-boolean v2, v7, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->j:Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/ParsableNalUnitBitArray;->e()I
    ...
    .line 412
    :goto_7
    iget-object v6, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->n:Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;

    invoke-virtual/range {v6 .. v20}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->a(Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;IIIIZZZZIIIII)V
...
.method public b()V
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->a()V
