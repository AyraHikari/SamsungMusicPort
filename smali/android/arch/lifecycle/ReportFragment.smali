...
# instance fields
.field private a:Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;
...
.method private b(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 54
    invoke-interface {p1}, Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;->a()V

    :cond_0
    return-void
.end method

.method private c(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 60
    invoke-interface {p1}, Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;->b()V

    :cond_0
    return-void
.end method

.method private d(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 66
    invoke-interface {p1}, Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;->c()V
...
# virtual methods
.method a(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    .locals 0

    .line 127
    iput-object p1, p0, Landroid/arch/lifecycle/ReportFragment;->a:Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 73
    iget-object p1, p0, Landroid/arch/lifecycle/ReportFragment;->a:Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;

    invoke-direct {p0, p1}, Landroid/arch/lifecycle/ReportFragment;->b(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
...
.method public onDestroy()V
    ...
    .line 108
    iput-object v0, p0, Landroid/arch/lifecycle/ReportFragment;->a:Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;
...
.method public onResume()V
    ...
    .line 87
    iget-object v0, p0, Landroid/arch/lifecycle/ReportFragment;->a:Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;

    invoke-direct {p0, v0}, Landroid/arch/lifecycle/ReportFragment;->d(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
...
.method public onStart()V
    ...
    invoke-direct {p0, v0}, Landroid/arch/lifecycle/ReportFragment;->c(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
