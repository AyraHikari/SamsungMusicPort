...
.method constructor <init>(Landroid/arch/lifecycle/LifecycleObserver;Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    iput-object p1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->b:Landroid/arch/lifecycle/GenericLifecycleObserver;

    .line 348
    iput-object p2, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;
...
.method a(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    .line 353
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iput-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;

    .line 354
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->b:Landroid/arch/lifecycle/GenericLifecycleObserver;
    ...
    .line 355
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;
