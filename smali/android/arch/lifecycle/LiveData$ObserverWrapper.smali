...
.method constructor <init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/Observer;)V
    ...
    .line 387
    iput-object p1, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->f:Landroid/arch/lifecycle/LiveData;
    ...
    .line 385
    iput p1, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->e:I

    .line 388
    iput-object p2, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->c:Landroid/arch/lifecycle/Observer;
...
.method a(Z)V
    ...
    .line 401
    iget-boolean v0, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->d:Z
    ...
    .line 406
    :cond_0
    iput-boolean p1, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->d:Z

    .line 407
    iget-object p1, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->f:Landroid/arch/lifecycle/LiveData;
    ...
    .line 408
    :goto_0
    iget-object v1, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->f:Landroid/arch/lifecycle/LiveData;

    invoke-static {v1}, Landroid/arch/lifecycle/LiveData;->c(Landroid/arch/lifecycle/LiveData;)I

    move-result v2

    iget-boolean v3, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->d:Z
    ...
    .line 409
    iget-boolean p1, p0, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->d:Z
