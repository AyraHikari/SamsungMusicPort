...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 163
    sget p2, Landroid/support/design/R$styleable;->FloatingActionButton_backgroundTint:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/widget/FloatingActionButton;->mBackgroundTint:Landroid/content/res/ColorStateList;

    .line 164
    sget p2, Landroid/support/design/R$styleable;->FloatingActionButton_backgroundTintMode:I
    ...
    invoke-static {p2, v0}, Landroid/support/design/widget/ViewUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/widget/FloatingActionButton;->mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;

    .line 166
    sget p2, Landroid/support/design/R$styleable;->FloatingActionButton_rippleColor:I
    ...
    iput p2, p0, Landroid/support/design/widget/FloatingActionButton;->mRippleColor:I

    .line 167
    sget p2, Landroid/support/design/R$styleable;->FloatingActionButton_fabSize:I

    invoke-virtual {p1, p2, p3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    iput p2, p0, Landroid/support/design/widget/FloatingActionButton;->mSize:I

    .line 168
    sget p2, Landroid/support/design/R$styleable;->FloatingActionButton_borderWidth:I

    invoke-virtual {p1, p2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, p0, Landroid/support/design/widget/FloatingActionButton;->mBorderWidth:I

    .line 169
    sget p2, Landroid/support/design/R$styleable;->FloatingActionButton_elevation:I
    ...
    .line 170
    sget v1, Landroid/support/design/R$styleable;->FloatingActionButton_pressedTranslationZ:I
    ...
    .line 172
    sget v1, Landroid/support/design/R$styleable;->FloatingActionButton_useCompatPadding:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, p0, Landroid/support/design/widget/FloatingActionButton;->mCompatPadding:Z
    ...
    sget v0, Landroid/support/design/R$dimen;->sesl_fab_image_size:I
    ...
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->mBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p1, v0, v1, v2, v3}, Landroid/support/design/widget/FloatingActionButtonImpl;->setBackgroundDrawable(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/design/widget/FloatingActionButtonImpl;->setElevation(F)V
    ...
    invoke-virtual {p1, p3}, Landroid/support/design/widget/FloatingActionButtonImpl;->setPressedTranslationZ(F)V
...
.method private getSizeDimension(I)I
    ...
    .line 451
    sget p1, Landroid/support/design/R$dimen;->sesl_fab_size_normal:I
    ...
    .line 448
    :cond_0
    sget p1, Landroid/support/design/R$dimen;->sesl_fab_size_mini:I
