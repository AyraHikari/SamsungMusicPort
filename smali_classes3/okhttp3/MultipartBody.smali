...
.method private a(Lokio/BufferedSink;Z)J
    ...
    invoke-interface {p1, v8}, Lokio/BufferedSink;->c([B)Lokio/BufferedSink;

    .line 138
    iget-object v8, p0, Lokhttp3/MultipartBody;->i:Lokio/ByteString;

    invoke-interface {p1, v8}, Lokio/BufferedSink;->b(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v10}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    .line 144
    invoke-interface {v10, v11}, Lokio/BufferedSink;->c([B)Lokio/BufferedSink;
    ...
    invoke-interface {v10, v11}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    .line 150
    :cond_1
    invoke-virtual {v6}, Lokhttp3/RequestBody;->a()Lokhttp3/MediaType;
    ...
    .line 152
    invoke-interface {p1, v8}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v8, v7}, Lokio/BufferedSink;->b(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    .line 157
    :cond_2
    invoke-virtual {v6}, Lokhttp3/RequestBody;->b()J
    ...
    .line 160
    invoke-interface {v9, v7, v8}, Lokio/BufferedSink;->m(J)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v9}, Lokio/BufferedSink;->c([B)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v6}, Lokio/BufferedSink;->c([B)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v1}, Lokio/BufferedSink;->c([B)Lokio/BufferedSink;

    .line 180
    iget-object v1, p0, Lokhttp3/MultipartBody;->i:Lokio/ByteString;

    invoke-interface {p1, v1}, Lokio/BufferedSink;->b(Lokio/ByteString;)Lokio/BufferedSink;
