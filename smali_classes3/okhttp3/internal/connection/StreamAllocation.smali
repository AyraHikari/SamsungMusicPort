...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lokhttp3/internal/connection/StreamAllocation;->d:Z
...
.method private a(IIIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 169
    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->o:Lokhttp3/internal/http/HttpCodec;

    if-nez v0, :cond_11

    .line 170
    iget-boolean v0, v1, Lokhttp3/internal/connection/StreamAllocation;->n:Z

    if-nez v0, :cond_10

    .line 174
    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->k:Lokhttp3/internal/connection/RealConnection;
    ...
    .line 176
    iget-object v4, v1, Lokhttp3/internal/connection/StreamAllocation;->k:Lokhttp3/internal/connection/RealConnection;
    ...
    .line 181
    :goto_0
    iget-boolean v6, v1, Lokhttp3/internal/connection/StreamAllocation;->l:Z
    ...
    iget-object v9, v1, Lokhttp3/internal/connection/StreamAllocation;->g:Lokhttp3/ConnectionPool;

    iget-object v10, v1, Lokhttp3/internal/connection/StreamAllocation;->a:Lokhttp3/Address;

    invoke-virtual {v8, v9, v10, v1, v5}, Lokhttp3/internal/Internal;->a(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;

    .line 189
    iget-object v8, v1, Lokhttp3/internal/connection/StreamAllocation;->k:Lokhttp3/internal/connection/RealConnection;
    ...
    .line 193
    :cond_2
    iget-object v8, v1, Lokhttp3/internal/connection/StreamAllocation;->f:Lokhttp3/Route;
    ...
    .line 217
    :goto_3
    iget-object v3, v1, Lokhttp3/internal/connection/StreamAllocation;->g:Lokhttp3/ConnectionPool;

    monitor-enter v3

    .line 218
    :try_start_1
    iget-boolean v4, v1, Lokhttp3/internal/connection/StreamAllocation;->n:Z
    ...
    iget-object v13, v1, Lokhttp3/internal/connection/StreamAllocation;->g:Lokhttp3/ConnectionPool;

    iget-object v14, v1, Lokhttp3/internal/connection/StreamAllocation;->a:Lokhttp3/Address;

    invoke-virtual {v12, v13, v14, v1, v11}, Lokhttp3/internal/Internal;->a(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;

    .line 227
    iget-object v12, v1, Lokhttp3/internal/connection/StreamAllocation;->k:Lokhttp3/internal/connection/RealConnection;
    ...
    .line 230
    iput-object v11, v1, Lokhttp3/internal/connection/StreamAllocation;->f:Lokhttp3/Route;
    ...
    .line 243
    :cond_b
    iput-object v9, v1, Lokhttp3/internal/connection/StreamAllocation;->f:Lokhttp3/Route;

    .line 244
    iput v7, v1, Lokhttp3/internal/connection/StreamAllocation;->j:I
    ...
    .line 252
    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->c:Lokhttp3/EventListener;
    ...
    .line 257
    :cond_d
    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->b:Lokhttp3/Call;
    ...
    invoke-virtual {v8}, Lokhttp3/internal/connection/RealConnection;->b()Lokhttp3/Route;

    move-result-object v2

    invoke-virtual {v0, v2}, Lokhttp3/internal/connection/RouteDatabase;->b(Lokhttp3/Route;)V
    ...
    .line 263
    :try_start_2
    iput-boolean v6, v1, Lokhttp3/internal/connection/StreamAllocation;->l:Z
    ...
    invoke-virtual {v0, v3, v8}, Lokhttp3/internal/Internal;->b(Lokhttp3/ConnectionPool;Lokhttp3/internal/connection/RealConnection;)V

    .line 270
    invoke-virtual {v8}, Lokhttp3/internal/connection/RealConnection;->f()Z
    ...
    invoke-virtual {v0, v3, v4, v1}, Lokhttp3/internal/Internal;->a(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;)Ljava/net/Socket;
    ...
    .line 275
    invoke-static {v5}, Lokhttp3/internal/Util;->a(Ljava/net/Socket;)V
...
.method public a(ZLokhttp3/internal/http/HttpCodec;JLjava/io/IOException;)V
    ...
    invoke-virtual {p1, p2}, Lokhttp3/EventListener;->b(Lokhttp3/Call;)V
