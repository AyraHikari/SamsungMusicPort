...
.method static a(Lokio/BufferedSource;)I
    ...
    .line 399
    invoke-interface {p0}, Lokio/BufferedSource;->i()B
...
.method private a(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {v0}, Lokio/BufferedSource;->k()I
    ...
    invoke-interface {v3}, Lokio/BufferedSource;->i()B
...
.method private d(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p2}, Lokio/BufferedSource;->k()I
...
.method private e(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2}, Lokio/BufferedSource;->j()S
    ...
    invoke-interface {v3}, Lokio/BufferedSource;->k()I
...
.method private g(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p4}, Lokio/BufferedSource;->k()I
...
.method private h(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p3, v1, v2}, Lokio/BufferedSource;->d(J)Lokio/ByteString;
...
.method private i(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 338
    invoke-interface {p1, p4, v1, v2}, Lokhttp3/internal/http2/Http2Reader$Handler;->a(IJ)V
...
.method public a(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v3, v4}, Lokio/BufferedSource;->d(J)Lokio/ByteString;
...
.method public a(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lokio/BufferedSource;->a(J)V
    :try_end_0
    ...
    invoke-interface {p1}, Lokio/BufferedSource;->i()B
    ...
    invoke-interface {p1, v0, v1}, Lokio/BufferedSource;->i(J)V
