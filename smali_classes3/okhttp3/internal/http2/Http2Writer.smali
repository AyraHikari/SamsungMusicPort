...
.method private static a(Lokio/BufferedSink;I)V
    ...
    .line 285
    invoke-interface {p0, p1}, Lokio/BufferedSink;->i(I)Lokio/BufferedSink;
...
.method private b(IJ)V
    ...
    .line 292
    :goto_1
    invoke-virtual {p0, p1, v2, v5, v0}, Lokhttp3/internal/http2/Http2Writer;->a(IIBB)V

    .line 293
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->c:Lokio/BufferedSink;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->e:Lokio/Buffer;

    invoke-interface {v0, v1, v3, v4}, Lokio/BufferedSink;->a_(Lokio/Buffer;J)V
...
.method a(IBLokio/Buffer;I)V
    ...
    invoke-interface {p1, p3, v0, v1}, Lokio/BufferedSink;->a_(Lokio/Buffer;J)V
...
.method public a(IIBB)V
    ...
    invoke-interface {p2, p1}, Lokio/BufferedSink;->g(I)Lokio/BufferedSink;
...
.method public declared-synchronized a(IILjava/util/List;)V
    ...
    .line 112
    invoke-virtual {p0, p1, p3, v3, v7}, Lokhttp3/internal/http2/Http2Writer;->a(IIBB)V
    ...
    invoke-interface {p3, p2}, Lokio/BufferedSink;->g(I)Lokio/BufferedSink;
    ...
    invoke-interface {p2, p3, v4, v5}, Lokio/BufferedSink;->a_(Lokio/Buffer;J)V
    ...
    .line 116
    invoke-direct {p0, p1, v0, v1}, Lokhttp3/internal/http2/Http2Writer;->b(IJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized a(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {p1, p3}, Lokio/BufferedSink;->c([B)Lokio/BufferedSink;
...
.method public declared-synchronized a(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/BufferedSink;->g(I)Lokio/BufferedSink;
...
.method a(ZILjava/util/List;)V
    ...
    .line 306
    invoke-virtual {p0, p2, p3, p1, v5}, Lokhttp3/internal/http2/Http2Writer;->a(IIBB)V
    ...
    invoke-interface {p1, p3, v2, v3}, Lokio/BufferedSink;->a_(Lokio/Buffer;J)V
    ...
    .line 309
    invoke-direct {p0, p2, v0, v1}, Lokhttp3/internal/http2/Http2Writer;->b(IJ)V
